...
$l['bad_word'] = "Palabra";
$l['bad_word_desc'] = "Introduce la palabra que deseas filtrar. El '*' representa cualquier número de caracteres y el símbolo '+' representa caracteres simples (otros como espacio o nueva línea).";
...
$l['regex_desc'] = "Tratar el campo \"Palabra\" como un campo de expresión regular.";
...
$l['error_invalid_regex'] = "La expresión regular especificada es incorrecta.";
