...
$l['error_format_dimension'] = "El fomato definido {1} es incorrecto.";
...
$l['error_field_memberlistmaxavatarsize'] = "Dimensionas máximas para mostrar avatar";
...
$l['setting_group_forumteam_desc'] = "Esta sección te permite controlar varios aspectos en la lista del equipo del foro(showteam.php), aspectos a considerar cuando ésta lista de miembros se muestre; y que mejoras estarán habilitadas o deshabilitadas.";

// Ajustes
$l['setting_enableshowteam'] = "Habilitar lista del equipo del foro?";
$l['setting_enableshowteam_desc'] = "Si deseas deshabilitar ésta mejora, selecciona No";
$l['setting_showaddlgroups'] = "Mostrar Grupos Adicionales";
$l['setting_showaddlgroups_desc'] = "Elije si deseas que la lista de equipo incluya los usuarios que están en algún grupo adicional como miembro del equipo del foro";
$l['setting_showgroupleaders'] = "Mostrar Líderes del Grupo";
$l['setting_showgroupleaders_desc'] = "Elije si deseas incluir los líderes de grupo en la lista de equipo del foro";