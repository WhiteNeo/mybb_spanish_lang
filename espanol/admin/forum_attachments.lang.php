...
$l['error_count'] = 'No se puede(n) eliminar {1} ajunto(s).';
...
$l['success_count'] = '{1} adjunto(s) eliminado(s) correctamente.';
...
$l['poster_is'] = "El creador del mensaje es";
$l['poster_is_either'] = "Usuario o invitado";
$l['poster_is_user'] = "Sólo usuarios";
$l['poster_is_guest'] = "Sólo invitados";
$l['more_than'] = "Más de";
