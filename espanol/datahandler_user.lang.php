...
$l['userdata_bad_password_security'] = 'La contraseña que has introducido es igual a tu nombre de usuario o a tu correo electrónico. Por favor, introduce una contraseña más segura.';

$l['userdata_missing_correo electrónico'] = 'No has introducido una dirección de correo electrónico. Por favor, introduce una.';
$l['userdata_invalid_correo electrónico_format'] = 'La dirección de correo electrónico que has introducido es inválida. Por favor, introduce un correo electrónico válido.';
$l['userdata_correo electrónicos_dont_match'] = 'La dirección de correo electrónico que has introducido en la confirmación no coincide con la original. Por favor, confirma correctamente tu correo electrónico.';
$l['userdata_banned_correo electrónico'] = "El correo electrónico que has introducido no se puede usar por estar deshabilitado. Por favor, introduce una dirección de correo electrónico diferente.";
$l['userdata_correo electrónico_already_in_use'] = "La dirección de correo electrónico que has introducido ya está en uso por otro miembro. Por favor, introduce una dirección de correo electrónico diferente.";
...
$l['userdata_away_too_long'] = 'La razón de inactividad especificada es demasiado larga. Se permite un máximo de 200 caracteres para este campo. Por favor elimine {1} caracter(es) para continuar.';
