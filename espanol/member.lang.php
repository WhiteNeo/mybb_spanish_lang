...
$l['nav_referrals'] = "Usuarios referidos por {1}";
$l['nav_profile'] = "Perfil de {1}";

$l['referrals'] = 'Referidos';
$l['referral_date'] = 'Fecha de referencia:';
$l['referrals_no_user_specified'] = 'No se agrego un referido.';
$l['member_no_referrals'] = 'No hay usuarios referidos por este usuario.';
...
$l['coppa_desc_for_deny'] = "Para registrarte en estos foros, necesitamos que verifiques tu edad con <a href=\"http://coppa.org/\" title=\"Children's Online Privacy Protection Act\" target=\"_blank\" rel=\"noopener\">COPPA</a>. Por favor introduce tu fecha de nacimiento debajo.";
...
$l['edit_ban_in_mcp'] = "Editar ban en el Panel de Moderación";
$l['lift_ban_in_mcp'] = "Retirar ban en el Panel de Moderación";
...
$l['js_validator_bad_password_security'] = 'La contraseña ingresada es parecida a tu nombre de usuario o dirección de correo electrónico. Por favor ingresa una contraseña con mayor seguridad.';
