...
$l['error_attachtype'] = "El tipo de archivo que intentaste adjuntar no está permitido. Quita ese archivo o escoge alguno otro de diferente tipo.";
$l['error_attachsize'] = "El archivo <b>{1}</b> que intentaste adjuntar es demasiado grande. El tamaño máximo para ese tipo de archivos es de {2} kilobytes.";
